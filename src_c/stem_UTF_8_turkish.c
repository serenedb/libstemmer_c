...
static const symbol s_5[] = { 'a', 'd' };
static const symbol s_6[] = { 's', 'o', 'y' };
...
static int r_mark_possessives(struct SN_env * z) {
    ...
    if (!find_among_b(z, a_0)) return 0;
    do {
        int v_1 = z->l - z->c;
...
static int r_mark_nUn(struct SN_env * z) {
    ...
    if (!find_among_b(z, a_3)) return 0;
    return r_1(z);
}
...
static int r_mark_yUm(struct SN_env * z) {
    ...
    if (!find_among_b(z, a_12)) return 0;
    return r_2(z);
}
...
static int r_mark_yUz(struct SN_env * z) {
    ...
    if (!find_among_b(z, a_14)) return 0;
    return r_2(z);
}

static int r_mark_sUnUz(struct SN_env * z) {
    if (z->c - 4 <= z->lb || z->p[z->c - 1] != 122) return 0;
    return find_among_b(z, a_15) != 0;
}
...
static int r_mark_yDU(struct SN_env * z) {
    ...
    if (!find_among_b(z, a_20)) return 0;
    return r_2(z);
}
...
extern int turkish_UTF_8_stem(struct SN_env * z) {
    ...
    z->lb = z->c; z->c = z->l;
    {
        ...
        lab7:
            ...
            if (!find_among_b(z, a_19)) goto lab11;
            do {
                int v_9 = z->l - z->c;
        ...
        lab17:
            ...
            if (!find_among_b(z, a_17)) goto lab22;
            do {
                int v_12 = z->l - z->c;
    ...
    if (!b_0) return 0;
    {
        ...
        lab36:
            ...
            if (!find_among_b(z, a_11)) goto lab38;
            if (!r_1(z)) goto lab38;
            z->bra = z->c;
            {
                int ret = slice_del(z);
        ...
        lab38:
            ...
            lab45:
                ...
                if (!find_among_b(z, a_5)) goto lab44;
            } while (0);
            do {
                int v_25 = z->l - z->c;
        ...
        lab44:
            ...
            do {
                ...
                if (!find_among_b(z, a_9)) goto lab50;
                break;
            lab50:
                z->c = z->l - v_27;
                if (!r_check_vowel_harmony(z)) goto lab49;
                if (!find_among_b(z, a_2)) goto lab49;
            } while (0);
            do {
                int v_28 = z->l - z->c;
        ...
        lab49:
            ...
            if (!find_among_b(z, a_8)) goto lab53;
            z->bra = z->c;
            {
                int ret = slice_del(z);
                if (ret < 0) return ret;
        ...
        lab53:
            ...
            lab60:
                ...
                if (!find_among_b(z, a_10)) goto lab59;
                if (!r_2(z)) goto lab59;
            } while (0);
            z->bra = z->c;
            {
    ...
    {
        int v_45 = z->l - z->c;
        if (!(eq_s_b(z, 2, s_5))) goto lab76;
        {
            int v_46 = z->l - z->c;
            if (!(eq_s_b(z, 3, s_6))) { z->c = z->l - v_46; goto lab77; }
        lab77:
            ;
        }
    ...
    }
    {
        ...
        lab84:
            z->c = z->l - v_48;
            do {
                if (!(eq_s_b(z, 2, s_1))) goto lab86;
                break;
            lab86:
                if (!(eq_s_b(z, 2, s_2))) goto lab78;
            } while (0);
            {

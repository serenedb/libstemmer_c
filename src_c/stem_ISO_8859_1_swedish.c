...
static const unsigned short a_3[] = {
    ...
    0xFFFD , S(7566), S(006C), 0x0000 , 0xF6F6 , 0xFFFE
};
    ...
    z->lb = z->c; z->c = z->l;
    {
        ...
        switch (among_var) {
            ...
            case 2:
                ...
                lab3:
                    z->c = z->l - v_5;
                    if (in_grouping_b(z, g_s_ending, 98, 121, 0)) goto lab2;
                } while (0);
                {
                    int ret = slice_del(z);
                    if (ret < 0) return ret;
    ...
    }
    {
        int v_6 = z->l - z->c;
        {
            ...
            v_7 = z->lb; z->lb = i_p1;
            {
                ...
                z->c = z->l - v_8;
                z->ket = z->c;
                if (z->c <= z->lb) { z->lb = v_7; goto lab4; }
                z->c--;
                z->bra = z->c;
                {
                    int ret = slice_del(z);
    ...
    }
    {
        ...
        switch (among_var) {
            case 1:
                ...
                break;
            case 2:
                if (in_grouping_b(z, g_ost_ending, 105, 118, 0)) goto lab5;
                {

...
static const unsigned short a_0[] = {
    0x0005 , 0xDF61 , 0x0081 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0084 , 0x0000 , 0x0087 , 0x0000 , 0x0000 , 0x0000 , 0x008A , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    ...
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0xFFFF , 0x0000 , 0x6565 , 0xFFFE , 0x0000 , 0x6565 , 0xFFFD , 0x0000 ,
    0x7575 , 0xC001 , 0x0000 , 0x6565 , 0xFFFC
};

static const unsigned short a_1[] = {
    0x0005 , 0xFC55 , 0xFFFE , 0x0000 , 0x0000 , 0x0000 , 0xFFFF , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    ...
    z->lb = z->c; z->c = z->l;
    {
        ...
        switch (among_var) {
            ...
            case 3:
                ...
                break;
            case 4:
                if (in_grouping_b(z, g_s_ending, 98, 116, 0)) goto lab8;
                {
                    int ret = slice_del(z);
                    if (ret < 0) return ret;
                }
    ...
    }
    {
        ...
        switch (among_var) {
            case 1:
                ...
                break;
            case 2:
                if (in_grouping_b(z, g_st_ending, 98, 116, 0)) goto lab11;
                if (z->c - 3 < z->lb) goto lab11;
                z->c -= 3;
                {
                    int ret = slice_del(z);
                    if (ret < 0) return ret;
            ...
            case 3:
                {
                    int v_12 = z->l - z->c;
                    if (in_grouping_b(z, g_et_ending, 85, 228, 0)) goto lab11;
                    z->c = z->l - v_12;
                }
                {
                    int v_13 = z->l - z->c;

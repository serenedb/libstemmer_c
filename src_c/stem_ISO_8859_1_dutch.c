...
static const unsigned short a_0[] = {
    0x0000 , 0xFC61 , 0xFFFF , 0x0000 , 0x0000 , 0x0000 , 0xFFFE , 0x0000 ,
    ...
    0x0000 , 0xFFFE , 0xFFFE , 0xFFFE , 0x009E , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0xFFFF , 0xFFFF , 0xFFFF , 0x0000 , 0xFFFF ,
    0x0000 , 0x0000 , 0xFFFF , 0xFFFF , 0xFFFF , 0xFFFF , 0x0000 , 0x6569 ,
    0xFFFD , 0xFFFC
};
...
static const unsigned short a_1[] = {
    ...
    0x0002 , 0xE927 , 0xFFFF , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    ...
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 , 0x0000 ,
    0x0000 , 0x0000 , 0x0000 , 0x0000 , 0xFFFB , 0x0004 , 0x6969 , 0xFFFD ,
    0x0000 , 0x6161 , 0xFFFA
};
            ...
            case 1:
                ...
                lab12:
                    ...
                    if (((SN_local *)z)->i_p1 > z->c) goto lab13;
                    {
                        ...
                        z->c--;
                        do {
                            if (in_grouping_b(z, g_v, 97, 252, 0)) goto lab14;
                            break;
                        lab14:
    ...
    b_GE_removed = 0;
    {
        int v_15 = z->c;
        {
            ...
            }
            {
                ...
                while (1) {
                    ...
                    do {
                        ...
                        break;
                    lab25:
                        if (in_grouping(z, g_v, 97, 252, 0)) goto lab24;
                    } while (0);
                    break;
                lab24:
                    z->c = v_19;
                ...
                while (1) {
                    ...
                    do {
                        ...
                        break;
                    lab27:
                        if (in_grouping(z, g_v, 97, 252, 0)) goto lab26;
                    } while (0);
                    continue;
                lab26:
                    z->c = v_20;
            ...
            }
            {
                int v_21 = z->c;
                z->bra = z->c;
                if (z->c >= z->l || (z->p[z->c + 0] != 235 && z->p[z->c + 0] != 239)) goto lab28;
    ...
    b_GE_removed = 0;
    {
        int v_23 = z->c;
        {
            ...
            }
            {
                ...
                while (1) {
                    ...
                    do {
                        ...
                        break;
                    lab33:
                        if (in_grouping(z, g_v, 97, 252, 0)) goto lab32;
                    } while (0);
                    break;
                lab32:
                    z->c = v_27;
                ...
                while (1) {
                    ...
                    do {
                        ...
                        break;
                    lab35:
                        if (in_grouping(z, g_v, 97, 252, 0)) goto lab34;
                    } while (0);
                    continue;
                lab34:
                    z->c = v_28;
            ...
            }
            {
                int v_29 = z->c;
                z->bra = z->c;
                if (z->c >= z->l || (z->p[z->c + 0] != 235 && z->p[z->c + 0] != 239)) goto lab36;

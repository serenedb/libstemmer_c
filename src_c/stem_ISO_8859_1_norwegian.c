...
static const unsigned short a_0[] = {
    ...
    0x0000 , 0x0000 , 0x002E , 0x0000 , 0x0036 , 0x0000 , 0x0002 , 0xC001 ,
    ...
    0xC001 , 0x0032 , 0x0000 , 0x61F8 , 0xC001 , 0xC001 , 0x3FFF , 0x6169 ,
    0x003A , 0x003D , 0x0000 , 0x6868 , 0xFFFF , 0x0000 , 0x6767 , 0xFFFF
};
    ...
    z->lb = z->c; z->c = z->l;
    {
        ...
        switch (among_var) {
            ...
            case 3:
                do {
                    int v_6 = z->l - z->c;
                    if (in_grouping_b(z, g_s_ending, 98, 122, 0)) goto lab5;
                    break;
                lab5:
                ...
                lab6:
                    ...
                    z->c--;
                    if (out_grouping_b(z, g_v, 97, 248, 0)) goto lab4;
                } while (0);
                {
                    int ret = slice_del(z);
                    if (ret < 0) return ret;
